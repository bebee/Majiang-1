  /**
    ...
    * All Rights Reserved. 
    * 使用方法：this.textTF.addText("haa<font size='60' color='0x2bff00' i='true' b='false'>aaaa</font>aaaaaa<i>aaaa</i>aaaaaaaa");
    */
module mui
{
  export class ETextField extends egret.TextField
  {
