...
class PersonItem extends egret.DisplayObjectContainer {
    ...
    initView() {
        ...
        this.texts[2].width = this.headIcon.width;
        this.texts[2].x = this.headIcon.x;
        this.texts[2].y = this.headIcon.y + this.headIcon.height + 5;

        this.texts[3].width = 340;
        this.texts[3].x = this.headIcon.x + this.headIcon.width + 20;
